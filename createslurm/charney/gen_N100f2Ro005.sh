...
for i in {1..50}
       	#${input[*]}
do 
	cp template.sh N100f2Ro005_run$i.sh
	echo "RUNDIR=\$SCRATCH/raytracing3D/arrayjobs/charney/N100/Ro005/2f_run${i}" >> N100f2Ro005_run$i.sh
        echo "mkdir -p \$RUNDIR 
cd \$RUNDIR 
...
exit
	" >> N100f2Ro005_run$i.sh
	sbatch N100f2Ro005_run$i.sh
done
